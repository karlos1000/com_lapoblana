...
class LapoblanaControllerCatstatus extends JControllerForm {
    ...
    function delete(){                      
        ...
        $model = JModelLegacy::getInstance('Catstatus', 'LapoblanaModel');                            
        $result = $model->deleteStatusById($idsProducts);
    ...
    function unpublish(){
        ...
        $model = JModelLegacy::getInstance('Catstatus', 'LapoblanaModel');
        //$msn = $model->existStatusInProdDetails($ids[0],$value);
        $model->updateActiveByIdStatus($ids, $value);  
        
        $msn= 'item successfully unpublished';
        $this->setRedirect('index.php?option=com_lapoblana&view=catstatus',$msn);
    }
    ...
    function publish(){
        ...
        $model = JModelLegacy::getInstance('Catstatus', 'LapoblanaModel');
        //$msn = $model->existStatusInProdDetails($ids[0]);
        $model->updateActiveByIdStatus($ids, $value);  
