...
class LapoblanaControllerCatdrawings extends JControllerForm {
    ...
    function delete(){                      
        ...
        $idsDrawings = JRequest::getVar('cid', array(), '', 'array');                
        // Sanitize the input
        JArrayHelper::toInteger($idsDrawings);
                                                                       
        $model = JModelLegacy::getInstance('Catdrawings', 'LapoblanaModel');                            
        $result = $model->deleteDrawingById($idsDrawings);
        ...
        $this->setRedirect('index.php?option=com_lapoblana&view=catdrawings', $msn);
...
//            $this->setRedirect('index.php?option=com_lapoblana&view=catdrawings', $text);                        
//        }
    ...
    function unpublish(){
        ...
        $model = JModelLegacy::getInstance('Catdrawings', 'LapoblanaModel');
        $model->updateActiveByIdDrawing($ids, $value);  
