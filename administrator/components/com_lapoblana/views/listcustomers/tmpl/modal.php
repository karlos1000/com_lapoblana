...
?>
<form action="<?php echo JRoute::_('index.php?option=com_lapoblana&view=listcustomers&layout=modal&tmpl=component&function='.$function);?>" method="post" name="adminForm" id="adminForm">
			...
			<tr class="row<?php echo $i=1-$i;?>">
				<td>
					<a class="pointer" onclick="if (window.parent) window.parent.<?php echo $function;?>
                                                ('<?php echo $item->name; ?>','<?php echo $item->username; ?>','<?php echo $item->idUser; ?>' );">
